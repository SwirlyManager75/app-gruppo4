...
def apply_watermark():
    bucket_name = "secchiellino2" # INSERT YOUR BUCKET NAME
    ...
    watermark_req_url = 'https://watermarker.expeditedaddons.com/?api_key=' + os.environ['WATERMARKER_API_KEY'] + '&height=100&image_url=' + get_s3_url(bucket_name,filename) + '&opacity=50&position=center&watermark_url=' + get_s3_url(bucket_name,qr_name) + '&width=100'
